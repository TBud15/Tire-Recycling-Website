      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">
            Dispose your tires with us
          </h1>
          <p className="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-400">
            Give your business and home a greener future with our tire recycling
            services. We offer an easy and convenient solution for businesses
            and individuals. Get rid of your worn tires: Click below to fill out
            the form and one of our experts will contact you.
          </p>
          <a
            href="#"
